...
from src.config import (
    hindi_vocab_size, english_vocab_size, TOTAL_ROWS,
    TOKENIZER_DIR,
...
class CustomTokenizer:
    ...
    def train(self, max_docs_hindi=hindi_vocab_size, max_docs_english=english_vocab_size):
        # Train Hindi alone
        ...
        seen_merges = set()
        hi, en = 0, 0
        hindi_slots = 6   # 6 Hindi merges per 1 English merge
